...
1. **Set up a Telegram Bot:**
   ...
   - Copy the API token into the [`token`](https://github.com/7GitGuru/TinyUrlrobot/blob/main/link_shortener.py#L4) variable in the [`link_shortener.py`](https://github.com/7GitGuru/TinyUrlrobot/blob/main/link_shortener.py) file.
